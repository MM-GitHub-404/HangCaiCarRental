...
<script type="text/javascript">
    ...
    layui.use(['jquery', 'layer', 'form', 'table', 'laydate'], function () {
        ...
        $("#doSearch").click(function () {
            ...
            $.post("${alfred}/xxxt_car/check/checkRentExist", {rentid: rentid}, function (obj) {
        ...
        function initCheckFormData(rentid) {
            $.post("${alfred}/xxxt_car/check/initCheckFormData",{rentid:rentid},function (obj) {
                //检查单
                var check=obj.check;
                ...
                $("#car_carimg").attr("src","${alfred}/xxxt_car/file/downloadShowFile?path="+car.carimg);
            })
        }
        //保存
        form.on("submit(doSubmit)",function () {
            var params = $("#checkFrm").serialize();
            $.post("${alfred}/xxxt_car/check/saveCheck",params,function (obj) {
                layer.msg(obj.msg);
                $("#content").hide();
            })
            return false;
