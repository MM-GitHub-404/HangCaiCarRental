...
<script type="text/javascript">
        ...
        layui.extend({
                ...
                tableIns = table.render({
                        ...
                        , url: '${alfred}/xxxt_car/role/loadAllRole' //数据接口
                ...
                $("#doSearch").click(function () {
                        ...
                        //alert(params);
                        tableIns.reload({
                                url: "${alfred}/xxxt_car/role/loadAllRole?" + params,
                                page:{curr:1}
                        })
                });
                ...
                table.on('tool(roleTable)', function (obj) {
                        ...
                        if (layEvent === 'del') { //删除
                                layer.confirm('真的删除【' + data.rolename + '】这个角色么？', function (index) {
                                        //向服务端发送删除指令
                                        $.post("${alfred}/xxxt_car/role/deleteRole", {roleid: data.roleid}, function (res) {
                                                layer.msg(res.msg);
                                                //刷新数据表格
                                                tableIns.reload();
                                        })
                ...
                function openAddRole() {
                        mainIndex = layer.open({
                                ...
                                success: function (index) {
                                        //清空表单数据
                                        $("#dataFrm")[0].reset();
                                        url = "${alfred}/xxxt_car/role/addRole";
                                }
                        });
                }
                ...
                function openUpdateRole(data) {
                        mainIndex = layer.open({
                                ...
                                success: function (index) {
                                        ...
                                        url = "${alfred}/xxxt_car/role/updateRole";
                                }
                        });
                }
                ...
                function deleteBatch() {
                        ...
                        layer.confirm('真的要删除这些角色么？', function (index) {
                                //向服务端发送删除指令
                                $.post("${alfred}/xxxt_car/role/deleteBatchRole",params, function (res) {
                                        layer.msg(res.msg);
                                        //刷新数据表格
                                        tableIns.reload();
                                })
                ...
                function openselectRoleMenu(data) {
                        ...
                        mainIndex=layer.open({
                                ...
                                yes:function (index, layero) {
                                        ...
                                        //保存角色和菜单的关系
                                        $.post("${alfred}/xxxt_car/role/saveRoleMenu",params,function (obj) {
                                                layer.msg(obj.msg);
                                                //关闭弹出层
                                                layer.close(mainIndex);
                                        })
                                ...
                                success:function (index) {
                                        ...
                                        menuTree = dtree.render({
                                                ...
                                                checkbarType:"all",
                                                checkbarData:"choose",
                                                url: "${alfred}/xxxt_car/role/initRoleMenuTreeJson?roleid="+data.roleid
                                        });
