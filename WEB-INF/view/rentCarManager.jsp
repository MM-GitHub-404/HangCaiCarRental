    ...
    layui.use(['jquery', 'layer', 'form', 'table', 'laydate'], function () {
        ...
        function initCarData() {
            ...
            tableIns = table.render({
                ...
                , url: '${alfred}/xxxt_car/car/loadAllCar?isrenting=0' //数据接口,查询所有未出租的车辆
                , title: '车辆列表'//数据导出来的标题
                , height: 'full-150'
                , page: true  //是否启用分页
                , cols: [[   //列表数据
        ...
        $("#doSearch").click(function () {
            ...
            $.post("${alfred}/xxxt_car/rent/checkCustomerExist", params, function (obj) {
        ...
        function openRentCar(data) {
            mainIndex = layer.open({
                ...
                success: function (index) {
                    ...
                    $.get("${alfred}/xxxt_car/rent/initRentFrom",{
                        identity:identity,
                        price:price,
                        carnumber:carnumber
                    },function (obj) {
        ...
        form.on("submit(doSubmit)", function (obj) {
            ...
            $.post("${alfred}/xxxt_car/rent/saveRent", params, function (obj) {
                layer.msg(obj.msg);
                //关闭弹出层
