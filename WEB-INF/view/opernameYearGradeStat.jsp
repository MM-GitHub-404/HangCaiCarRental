...
<script type="text/javascript" src="${alfred}/xxxt_car/resources/echarts/js/echarts.min.js"></script>
<script type="text/javascript" src="${alfred}/xxxt_car/resources/echarts/js/jquery-3.1.1.min.js"></script>
...
<script type="text/javascript">
    ...
    layui.use(['jquery', 'layer', 'form', 'table', 'laydate'], function () {
        ...
        function getData() {
            ...
            $.get("${alfred}/xxxt_car/stat/loadOpernameYearGradeStatJson",{year:year},function (data) {
