...
<script type="text/javascript">
    ...
    layui.use(['jquery', 'layer', 'form', 'table', 'laydate'], function () {
        ...
        tableIns = table.render({
            ...
            , url: '${alfred}/xxxt_car/rent/loadAllRent' //数据接口
        ...
        $("#doSearch").click(function () {
            ...
            tableIns.reload({
                url: "${alfred}/xxxt_car/rent/loadAllRent?" + params,
                page: {curr: 1}
            })
        });
        //批量导出
        $("#doExport").click(function () {
            var params = $("#searchFrm").serialize();
            window.location.href="${alfred}/xxxt_car/stat/batchExportRent?"+params;
        });
        //监听行工具事件
        table.on('tool(rentTable)', function (obj) {
            ...
            if (layEvent === 'del') { //删除
                layer.confirm('真的删除【' + data.rentid + '】这个出租单么？', function (index) {
                    //向服务端发送删除指令
                    $.post("${alfred}/xxxt_car/rent/deleteRent", {rentid: data.rentid}, function (res) {
                        layer.msg(res.msg);
                        //刷新数据表格
                        tableIns.reload();
                    })
                ...
                window.location.href="${alfred}/xxxt_car/stat/exportRent?rentid="+data.rentid;
            }
        });
        ...
        function openUpdateRent(data) {
            mainIndex = layer.open({
                ...
                success: function (index) {
                    ...
                    url = "${alfred}/xxxt_car/rent/updateRent";
                }
            });
        }
