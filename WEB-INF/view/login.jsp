...
<head>
	...
	<link rel="icon" href="${alfred}/xxxt_car/resources/favicon.ico">
...
<br><br>
<%--<h3 style='margin-top:30px;height:20px;font-size: 30px;font-weight: bold;color:white;float:right;text-align:right;'>茂茂汽车租赁管理系统</h3>--%>
<h3 align="center"  style="color:#FFFFFF ; font-size: 60px;text-align:center;">茂茂汽车租赁管理系统</h3>
	<br><br>
	<form class="layui-form" id="loginFrm" method="post" action="${alfred}/xxxt_car/login/login">
		<div class="login_face"><img src="${alfred}/xxxt_car/resources/images/face01.jpg" class="userAvatar"></div>
		...
		<div class="layui-form-item input-item" id="imgCode">
			...
			<img src="${alfred}/xxxt_car/login/getCode" onclick="this.src=this.src+'?'">
		</div>
