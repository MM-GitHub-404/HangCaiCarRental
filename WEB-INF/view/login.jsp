...
<form class="layui-form" id="loginFrm" method="post" action="/HangCaiCarRental/login/passwordLogin">
    ...
    <div class="layui-form-item input-item">
        ...
        <input type="text" placeholder="请输入工号" autocomplete="off" name="jobId" id="loginname" class="layui-input"
               lay-verify="required">
    </div>

    <div class="layui-form-item input-item" id="password-item">
        <label for="employeePassword">密码</label>
        <input type="password" placeholder="请输入密码" autocomplete="off" name="employeePassword" id="employeePassword"
    ...
    <div class="layui-form-item input-item" id="imgCode">
        ...
        <input type="text" placeholder="请输入验证码" autocomplete="off" name="captcha" id="code" class="layui-input"
               lay-verify="required">
    ...
    <div class=layui-toggle-btn>
        ...
        <!-- 现在使用<a>标签进行页面跳转 -->
        <a href="/HangCaiCarRental/navigation/toEmailLogin" class="layui-toggle-btn1">邮箱登录</a>
    </div>
